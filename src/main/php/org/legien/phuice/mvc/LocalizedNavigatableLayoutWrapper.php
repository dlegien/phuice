<?php
	 ...
	 *
	 */
	class LocalizedNavigatableLayoutWrapper extends LocalizedLayoutWrapper 
	{
		/**
		 ...
		 */
		public function __construct(Translator $translator, $filename, MenuStorage $menuStorage) 
		{
			parent::__construct($translator, $filename);
